...
<nav class = "nav-bar-2">
    ...
    <?php } else{?>
    <a style= "float:right; margin-right:10px;" href="#" data-activates="slide-out" class="button-collapse"><i style = "color:#fff;font-size:35px;" class="large material-icons">menu</i></a>
    <?php }?>
    </div>
     <a href = "index.php"><img class = "logo1" style = "float:left;width: 100px;" src = "/assets/logo.png"/></a>
      <form action = "/search" class = "search-form" style = "margin-top:4px;">
          <span style="margin-left:0;margin-right:0;margin-top:0;margin-bottom:0;position: relative; z-index: 1; display: inline-block;vertical-align: top;" class="searchbar-2 input--makiko">
          <input id = "searchbar" autocomplete="off" name = "req" style="border:none;font-size:25px;height:60px;" class="input__field input__field--makiko" value = '<?php echo $search;?>' type="text" onkeypress="return onlyAlphabets(event,this);">
          ...
          <ul  class="list-group result1" id = "result"></ul><br>
