...
#sidenav-overlay {
  ...
  <!-- Side nav  -->
  <span style = "margin:10px;"><u><a href = "/topcontributors" style = "color:#fff;">Top Contributors</a> &nbsp; <a href= '/about' style = "color:#fff;">About us</a></u></span>
  ...
  <a style= "float:right; margin-right:10px;" href="#"><i style ="margin-top: 10px;" class=" material-icons">close</i></a>
    ...
    <span class="input input--jiro">
      ...
      <span class="input input--jiro">
          <input name = "password" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="password" id="input-12" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-12">
      ...
      <p style = "font-size:12px;">Still no account? Please go to <a style="color:#62a8ea;font-size:16px;"  href="#" data-activates="slide-out1" class="button-collapse1">Sign up</a></p><br>
   ...
   <ul id="slide-out5" class="side-nav" style="list-style: none;">
    <li><div class="user-view">
      ...
      <a href="#"><img id = "user1" class="circle" style="border-radius: 100%;" src = "/assets/img/usr/<?php echo $_SESSION['usr_id'];?>.jpg" onError="this.onerror=null;this.src= '/assets/img/usr/sample.png';"></a>
      <a href="#"><span id = "user_name" class="white-text name" style="color:white;"><?php echo $_SESSION['usr_name'];?></span></a>
      <a href="#"><span id = "user_email" class="white-text email" style="color:white;"><?php echo $_SESSION['usr_email'];?></span></a>
    </div></li>
  ...
  <a style= "float:right; margin-right:10px;" href="#"><i style ="margin-top: 10px;" class=" material-icons">close</i></a>
    ...
    <center>
    <span class="input input--jiro">
          <input name = "name" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="name" id="input-13" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-13">
            <span class="input__label-content input__label-content--jiro">Name</span>
          </label>
      </span>
    <span class="input input--jiro">
          <input name = "email" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="email" id="input-14" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-14">
            <span class="input__label-content input__label-content--jiro">Email</span>
          </label>
      </span>
      <span class="input input--jiro">
          <input name = "password" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="password" id="input-15" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-15">
            <span class="input__label-content input__label-content--jiro">Password</span>
          </label>
      </span>
      <span class="input input--jiro">
          <input name = "cpassword" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="password" id="input-16" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-16">
  ...
  <a style= "float:right; margin-right:10px;" href="#"><i style ="margin-top: 10px;" class=" material-icons">close</i></a>
    ...
    <center>
    <span class="input input--jiro">
          <input name = "email" style = "font-size:12px;border:none;" class="input__field input__field--jiro" type="email" id="input-17" required>
          <label style = "font-size:12px; padding-bottom:20px;" class="input__label input__label--jiro" for="input-17">
            <span class="input__label-content input__label-content--jiro">Email</span>
          </label>
      </span>
      <br><br>
  ...
  <?php if (isset($_SESSION['usr_id'])){?>
    ...
    <?php } else{?>
      <a style= "float:right; margin-right:10px;" href="#" data-activates="slide-out" class="button-collapse"><i style = "font-size:35px;color:#fff;" class="large material-icons">menu</i></a>
    <?php }?>
  </div>
</nav>
 <script>
